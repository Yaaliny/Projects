...
public class JourneyDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(JourneyDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(JourneyDetailFragment.ARG_ITEM_ID));
            JourneyDetailFragment fragment = new JourneyDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.journey_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, JourneyListActivity.class));
            return true;
        }
